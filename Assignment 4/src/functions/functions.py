...
from src.domain.entity import get_type, get_day, get_money, set_money, check_type, create_expense
from src.ui.console import display_by_category2, display_by_days2, display_none, display_none2, \
